...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_app_js_store__ = __webpack_require__(/*! app/js/store */ 40);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_html_js_html__ = __webpack_require__(/*! html/js/html */ 42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_transition_js_transition__ = __webpack_require__(/*! transition/js/transition */ 43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_action_js_action__ = __webpack_require__(/*! action/js/action */ 44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_form_js_form__ = __webpack_require__(/*! form/js/form */ 45);
    ...
    for (let key in self.$refs) {
      ...
      if (key.startsWith("select.")) {
        if (key.startsWith("select.multiple.")) {
          ...
          if (self.$refs[key]["attributes"]["init-value"]) {
            if (self.$refs[key]["attributes"]["value-type"]["value"] == "Integer") data[key.replace('select.', '')] = parseInt(self.$refs[key]["attributes"]["init-value"]["value"]);else {
