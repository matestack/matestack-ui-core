...
The basic Vue.js Ruby component API is the same as described within the [component API documenation](https://github.com/matestack/matestack-ui-core/tree/0e84336eae78e6c86403c0c60fbe8fca4bcd8081/docs/api/000-base/20-component.md). The options below extend this API.
