...
describe "Component", type: :feature, js: true do
  ...
  describe "CORE component naming and namespaces" do
    ...
    # the component resolving approach has massively changed
    # the old behavior of resolving core components is only possible, if core components are
    # explicitly registered in a way which follows the old auto resolving strategy
  ...
  # the component resolving approach has massively changed
  # the old behavior of resolving custom components is only possible, if custom components are
  # explicitly registered in a way which follows the old auto resolving strategy
