...
describe "Async Component", type: :feature, js: true do
  ...
  it "show on event" do
    class ExamplePage < Matestack::Ui::Page
      def response
        toggle show_on: "my_event", id: 'async-div' do
          div id: "my-div" do
            plain "#{DateTime.now.strftime('%Q')}"
          end
        end
        toggle show_on: "multi_event_1, multi_event_2", id: 'async-second-div' do
  ...
  it "hide on event" do
    class ExamplePage < Matestack::Ui::Page
      def response
        toggle hide_on: "my_event", id: 'async-div' do
          div id: "my-div" do
            plain "#{DateTime.now.strftime('%Q')}"
          end
        end
        toggle hide_on: "multi_event_1, multi_event_2", id: 'async-second-div' do
          div id: "my-second-div" do
            plain "#{DateTime.now.strftime('%Q')}"
          end
        end
  ...
  it "show on / hide on combination init not shown by default" do
    class ExamplePage < Matestack::Ui::Page
      def response
        toggle show_on: "my_show_event", hide_on: "my_hide_event", id: 'async-div' do
          div id: "my-div" do
            plain "#{DateTime.now.strftime('%Q')}"
          end
        end
  ...
  it "show on / hide on combination init shown if configured" do
    class ExamplePage < Matestack::Ui::Page
      def response
        toggle show_on: "my_show_event", hide_on: "my_hide_event", init_show: true, id: 'async-div' do
          div id: "my-div" do
            plain "#{DateTime.now.strftime('%Q')}"
          end
        end
  ...
  it "hide after show on event" do
    class ExamplePage < Matestack::Ui::Page
      def response
        toggle show_on: "my_event", hide_after: 1000, id: 'async-div' do
          div id: "my-div" do
            plain "#{DateTime.now.strftime('%Q')}"
          end
        end
