...
describe "form radio", type: :feature, js: true do

  before :all do
    Rails.application.routes.append do
      scope "form_radio_error_spec" do
        post '/radio_error_failure_form_test/:id', to: 'form_test#failure_submit', as: 'radio_error_failure_form_test'
      end
    end
      ...
      def form_config
        {
          for: :my_object,
          method: :post,
          path: radio_error_failure_form_test_path(id:42),
        }
      end
    end
  ...
  it "can turn off error messages" do
    class ExamplePage < Matestack::Ui::Page
      def response
        matestack_form form_config do
          form_radio id: "foo", key: :foo, options: [1, 2], errors: false
          button text: "Submit me!"
        end
      end
  ...
  it "lets you customize errors" do
    class ExamplePage < Matestack::Ui::Page
      def response
        matestack_form form_config do
          form_radio id: "foo", key: :foo, options: [1, 2], errors: { wrapper: {}, tag: :div, class: 'my-error' }
          button text: "Submit me!"
        end
      end
  ...
  it "lets you customize errors and errors wrapper" do
    class ExamplePage < Matestack::Ui::Page
      def response
        matestack_form form_config do
          form_radio id: "foo", key: :foo, options: [1, 2], errors: {
