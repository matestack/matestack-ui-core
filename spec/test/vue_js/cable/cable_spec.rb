...
describe "Cable Component", type: :feature, js: true do
  ...
  it 'should work after a page transition' do
    matestack_vue_js_render(reset_app: false, page: MatestackTransitionPage) do
    ...
    page.execute_script('MatestackUiVueJs.eventHub.$emit("replace", { data: "<h1 id=\"id\">replaced</h1>" })')
  ...
  it 'should be possible to add vue.js components' do
    ...
    script = "MatestackUiVueJs.eventHub.$emit('replace', { data: \'#{onclick}\' })".gsub("\n", "")
