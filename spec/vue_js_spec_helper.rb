...
Dir[File.join File.dirname(__FILE__), 'test', 'vue_js', 'support', '**', '*.rb'].each { |f| require f }
...
=end
  ...
  config.before :all, type: :feature do
    Rails.application.routes.append do
      get '/matestack_components_test', to: 'matestack_vue_js_components#matestack_components_test', as: :matestack_components_test unless Rails.application.routes.url_helpers.method_defined?(:matestack_components_test_path)
      get '/matestack_transition_test', to: 'matestack_vue_js_components#matestack_transition_test', as: :matestack_transition_test unless Rails.application.routes.url_helpers.method_defined?(:matestack_transition_test_path)
