class Demo::VueJs::Pages::SecondPage < Matestack::Ui::Page

  def response
    h2 "Second Page"
    paragraph do
      plain "play around! --> spec/dummy/app/matestack/demo/vue_js/pages/second_page.rb"
    end

    # you can call components on pages:
    Demo::VueJs::Components::StaticComponent.call(foo: "baz")

    action path: demo_vue_js_ssr_call_path, method: :post do
  ...
  def form_config_1
    {
      for: :some_object,
      path: demo_vue_js_form_submit_path,
      method: :post,
      multipart: true
    }
  end
