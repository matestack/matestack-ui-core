  ...
  module Ui
    module VueJs
      module Components
          ...
          def m_form(text=nil, options=nil, &block)
          ...
          def collection_next(text=nil, options=nil, &block)
             Matestack::Ui::VueJs::Components::Collection::Next.(text, options, &block)
          end

          def collection_previous(text=nil, options=nil, &block)
             Matestack::Ui::VueJs::Components::Collection::Previous.(text, options, &block)
          end

          def collection_page(text=nil, options=nil, &block)
