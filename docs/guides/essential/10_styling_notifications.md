...
After introducing vue.js components in the [previous guide](/docs/guides/essential/09_custom_vue_js_components.md), it's time to work on the appearance and user experience of the application.
...
Going ahead, the next part of this series covers [authentication via Devise](/docs/guides/essential/11_authentication_devise.md).
