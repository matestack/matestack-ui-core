...
In the [previous guide](guides/100-tutorial/02_active_record.md), we added an ActiveRecord model to our project, added some fake persons to our database and displayed them on an index page.
...
We expect you to have successfully finished the [previous guide](guides/100-tutorial/02_active_record.md).
...
Let's continue and add the necessary functionality for adding new persons and editing existing ones in the [next part of the series](/docs/guides/100-tutorial/04_form_create_update_delete.md).
