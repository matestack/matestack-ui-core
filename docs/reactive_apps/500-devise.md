...
Creating a sign out button in matestack is very straight forward. We use matestacks [`action` component](../api/100-components/action.md) to create a sign out button. See the example below:
